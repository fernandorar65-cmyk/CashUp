...
describe('amortizationService', () => {
  ...
  describe('generateSchedule', () => {
    it('genera N cuotas para N meses', () => {
      const schedule = generateSchedule(10000, 0.24, 12, new Date('2025-01-01'));
    ...
    it('suma de principal igual al monto del préstamo', () => {
      const schedule = generateSchedule(5000, 0.12, 6, new Date('2025-01-01'));
  ...
  describe('calculateTotalToPay', () => {
    it('total sin interés = principal', () => {
      const total = calculateTotalToPay(6000, 0, 6);
      expect(total).toBe(6000);
    });

    it('total con interés > principal', () => {
      const total = calculateTotalToPay(10000, 0.24, 12);
  ...
  describe('calculateLatePenalty', () => {
    it('devuelve número positivo para monto y días positivos', () => {
      const penalty = calculateLatePenalty(100, 30);
